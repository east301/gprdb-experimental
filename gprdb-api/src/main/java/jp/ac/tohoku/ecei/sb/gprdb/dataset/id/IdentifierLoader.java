 ...
 * @author Shu Tadaka
 */
public interface IdentifierLoader extends Closeable {

    /**
     * Loads identifier information.
     *
     ...
     */
    void load(@NotNull Consumer<RawIdentifierInfo> callback) throws IOException, ParseException;
